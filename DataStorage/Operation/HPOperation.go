...
func HPFloat64(x int) float64 {
	ret,_ := decimal.New(int64(x),0).Float64()
	return ret
}

func HPFloat64FromString(x string) float64 {
...
func HPIntMul(x float64,y int64) float64 {
	ret,_ := decimal.NewFromFloat(x).Mul(decimal.New(y,0)).Float64()
	return ret
