...
var (
	EURUSDBaseURL 		= "https://webrates.truefx.com/rates/connect.html?p=anystring&f=csv&s=n&c=EUR/USD"
	...
	for {
		...
		case <-tick:
			...
			if count == ForexReconnctMaxTime {
				log.Printf("ERROR----request eurusd 3th failed, close eurusd server----err:%v\n", err)
...
func main() {
	var pricepath= "/root/DataStorage/eurusdprice.csv"
	...
	var tradepath = "/root/DataStorage/eurusdtrade.csv"
